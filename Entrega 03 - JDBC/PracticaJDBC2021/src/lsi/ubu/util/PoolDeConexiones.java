...
public class PoolDeConexiones {
	...
	// Tip: si hay problemas de conexion, comprueba que en la BD el password esta en minusculas,
	 ...
	 *
	 * @throws RuntimeException si no encuentra el el recurso JNDI, y por tanto no logra instanciar el pool
	 */
